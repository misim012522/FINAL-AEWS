      ...
      <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <h2 className="text-lg font-bold text-slate-900">Previous Final Grades - {subjectCode}: {subjectName}</h2>
              </div>
              <p className="text-sm text-slate-600">Previous-semester final records with component scores and computed final grades.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-3">
            ...
            <p className="text-xl font-bold text-slate-900">{formatScoreValue(averageFinal)}</p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-white p-3">
