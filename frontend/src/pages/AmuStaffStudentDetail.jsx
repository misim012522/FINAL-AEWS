      ...
      .then((data) => {
        ...
        return listInterventions().then((list) => {
          ...
          const byStudent = (list || []).filter(
            (i) => (i.student && data.student_email && i.student.toLowerCase().includes(data.student_email.split('@')[0])) || (i.student && data.student_name && i.student === data.student_name)
          )
          ...
          <div className="p-2 border-b border-gray-200">
            <div className="flex items-start gap-1.5">
              ...
              <div className="flex-1">
                <h1 className="text-xs font-bold text-gray-900">{student.student_name || student.student_email}</h1>
