          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
              ...
              <select
                ...
                className="w-full sm:w-40 rounded-xl border border-slate-200 px-3 py-2.5 text-sm font-medium text-slate-700 bg-white hover:border-slate-300 focus:ring-2 focus:ring-teal-500/20 outline-none transition-colors"
              >
                          ...
                          <td className="px-2 py-1.5 align-top">
                            <div className="flex flex-wrap items-center gap-1">
                              <button
                                ...
                                className="inline-flex items-center gap-1 text-[11px] font-semibold text-white bg-teal-600 hover:bg-teal-700 disabled:bg-slate-300 disabled:cursor-not-allowed px-2 py-1 rounded transition-colors"
                              >
                                {isExpanded ? <X className="w-2.5 h-2.5" /> : <ClipboardPlus className="w-2.5 h-2.5" />}
                              ...
                              <div className="rounded-xl border border-teal-200 bg-white p-4">
                                <div className="flex flex-col lg:flex-row lg:items-end gap-3">
                                  <div className="flex-1">
                                    ...
                                    <input
                                      ...
                                      className="w-full rounded-xl border border-slate-200 px-3 py-2.5 text-sm text-slate-900 focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 outline-none"
                                    />
                                  </div>
                                  ...
                                  <div className="w-full lg:w-auto">
                                    <button
                                      ...
                                      className="w-full lg:w-auto inline-flex items-center justify-center gap-2 rounded-xl bg-teal-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-teal-700 disabled:opacity-60"
                                    >
                                ...
                                {r.referral_note && (
                                  <div className="mt-3 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2">
                                    <p className="text-[10px] font-semibold uppercase tracking-wider text-amber-700">Referral note</p>
                                    <p className="mt-1 text-[11px] leading-relaxed text-amber-900 whitespace-pre-line">{r.referral_note}</p>
                                  </div>
                                )}
                              </div>
                            </td>
