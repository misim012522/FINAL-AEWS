  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-blue-200 bg-blue-50 px-4 py-3">
        ...
        <p className="text-sm text-blue-800 mt-1">{activeProfile.description}</p>
        {!hasAccuracyData && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-xs uppercase tracking-wide text-gray-500">Best Accuracy</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-xs uppercase tracking-wide text-gray-500">Precision</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-xs uppercase tracking-wide text-gray-500">Recall</p>
        ...
        <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
          <p className="text-xs uppercase tracking-wide text-gray-500">Last Trained</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {modelCards.map((model) => {
          ...
          return (
            <div key={model.key} className="bg-white rounded-xl border border-gray-200/80 shadow-sm p-4">
              <p className="text-xs uppercase tracking-wide text-gray-500">{model.label}</p>
              <p className={`text-2xl font-bold mt-2 ${model.color}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        <div>
          ...
          <div className="bg-white rounded-xl border border-gray-200/80 shadow-sm hover:shadow-md transition-shadow p-3">
